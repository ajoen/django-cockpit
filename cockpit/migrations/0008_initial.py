...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'cockpit_page', (
            ...
            ('parent', self.gf('mptt.fields.TreeForeignKey')(to=orm['cockpit.Page'], null=True, blank=True)),
    ...
    models = {
        u'cockpit.page': {
            ...
            'parent': ('mptt.fields.TreeForeignKey', [], {'to': u"orm['cockpit.Page']", 'null': 'True', 'blank': 'True'}),
