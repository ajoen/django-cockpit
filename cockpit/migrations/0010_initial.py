...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'cockpit_page', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('parent', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['cockpit.Page'], null=True, blank=True)),
    ...
    models = {
        u'cockpit.page': {
            ...
            'parent': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['cockpit.Page']", 'null': 'True', 'blank': 'True'})
        },
