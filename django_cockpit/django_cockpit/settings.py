...
DATABASES = {
    'default': {
        ...
        'NAME': '../django_cockpit/db',                      # Or path to database file if using sqlite3.
...
SECRET_KEY = '^5^@b74joi@6u3_8!n#vthi5f&*7wxl5_0-p=v##10sh7f06@&'
...
ROOT_URLCONF = 'django_cockpit.urls'

# Python dotted path to the WSGI application used by Django's runserver.
WSGI_APPLICATION = 'django_cockpit.wsgi.application'
